...
# ----------------
# Module mandrel 22.0.0.2-Final-java11-arm64
...
# Artifact mandrel-java11-linux-aarch64-22.0.0.2-Final.tar.gz downloaded from https://github.com/graalvm/mandrel/releases/download/mandrel-22.0.0.2-Final/mandrel-java11-linux-aarch64-22.0.0.2-Final.tar.gz
COPY /target/artifacts/mandrel-java11-linux-aarch64-22.0.0.2-Final.tar.gz /tmp/mandrel-java11-linux-aarch64-22.0.0.2-Final.tar.gz
RUN mkdir -p /opt/mandrel \
    && tar xzf /tmp/mandrel-java11-linux-aarch64-22.0.0.2-Final.tar.gz -C /opt/mandrel --strip-components=1 \
    && rm -Rf /tmp/mandrel-java11-linux-aarch64-22.0.0.2-Final.tar.gz
# ----------------
