...
COPY /artifacts/mandrel-java11-linux-amd64-21.3.1.0-Final.tar.gz /tmp/mandrel-java11-linux-amd64-21.3.1.0-Final.tar.gz
RUN mkdir -p /opt/mandrel \
    && tar xzf /tmp/mandrel-java11-linux-amd64-21.3.1.0-Final.tar.gz -C /opt/mandrel --strip-components=1 \
    && rm -Rf /tmp/mandrel-java11-linux-amd64-21.3.1.0-Final.tar.gz
# ----------------
