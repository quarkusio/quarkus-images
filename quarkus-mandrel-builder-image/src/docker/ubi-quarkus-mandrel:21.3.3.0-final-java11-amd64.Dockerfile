...
# ----------------
# Module mandrel 21.3.3.0-Final-java11-amd64
...
# Artifact mandrel-java11-linux-amd64-21.3.3.0-Final.tar.gz downloaded from https://github.com/graalvm/mandrel/releases/download/mandrel-21.3.3.0-Final/mandrel-java11-linux-amd64-21.3.3.0-Final.tar.gz
COPY /target/artifacts/mandrel-java11-linux-amd64-21.3.3.0-Final.tar.gz /tmp/mandrel-java11-linux-amd64-21.3.3.0-Final.tar.gz
RUN mkdir -p /opt/mandrel \
    && tar xzf /tmp/mandrel-java11-linux-amd64-21.3.3.0-Final.tar.gz -C /opt/mandrel --strip-components=1 \
    && rm -Rf /tmp/mandrel-java11-linux-amd64-21.3.3.0-Final.tar.gz
# ----------------
