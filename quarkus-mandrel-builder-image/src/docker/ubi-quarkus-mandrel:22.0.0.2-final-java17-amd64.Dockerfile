...
# ----------------
# Module mandrel 22.0.0.2-Final-java17-amd64
...
# Artifact mandrel-java17-linux-amd64-22.0.0.2-Final.tar.gz downloaded from https://github.com/graalvm/mandrel/releases/download/mandrel-22.0.0.2-Final/mandrel-java17-linux-amd64-22.0.0.2-Final.tar.gz
COPY /target/artifacts/mandrel-java17-linux-amd64-22.0.0.2-Final.tar.gz /tmp/mandrel-java17-linux-amd64-22.0.0.2-Final.tar.gz
RUN mkdir -p /opt/mandrel \
    && tar xzf /tmp/mandrel-java17-linux-amd64-22.0.0.2-Final.tar.gz -C /opt/mandrel --strip-components=1 \
    && rm -Rf /tmp/mandrel-java17-linux-amd64-22.0.0.2-Final.tar.gz
# ----------------
