...
# ----------------
# Module mandrel 22.2.0.0-Final-java17-arm64
...
# Artifact mandrel-java17-linux-aarch64-22.2.0.0-Final.tar.gz downloaded from https://github.com/graalvm/mandrel/releases/download/mandrel-22.2.0.0-Final/mandrel-java17-linux-aarch64-22.2.0.0-Final.tar.gz
COPY /target/artifacts/mandrel-java17-linux-aarch64-22.2.0.0-Final.tar.gz /tmp/mandrel-java17-linux-aarch64-22.2.0.0-Final.tar.gz
RUN mkdir -p /opt/mandrel \
    && tar xzf /tmp/mandrel-java17-linux-aarch64-22.2.0.0-Final.tar.gz -C /opt/mandrel --strip-components=1 \
    && rm -Rf /tmp/mandrel-java17-linux-aarch64-22.2.0.0-Final.tar.gz
# ----------------
