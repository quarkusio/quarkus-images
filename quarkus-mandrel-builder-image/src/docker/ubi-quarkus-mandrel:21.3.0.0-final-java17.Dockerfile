...
# ----------------
# Module mandrel 21.3.0.0-Final-null
...
COPY /artifacts/mandrel-java17-linux-amd64-21.3.0.0-Final.tar.gz /tmp/mandrel-java17-linux-amd64-21.3.0.0-Final.tar.gz
RUN mkdir -p /opt/mandrel \
    && tar xzf /tmp/mandrel-java17-linux-amd64-21.3.0.0-Final.tar.gz -C /opt/mandrel --strip-components=1 \
    && rm -Rf /tmp/mandrel-java17-linux-amd64-21.3.0.0-Final.tar.gz
# ----------------
