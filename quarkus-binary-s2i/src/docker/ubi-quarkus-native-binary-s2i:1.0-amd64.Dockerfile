...
COPY quarkus-binary-s2i/src/main/resources/scripts/assemble /usr/libexec/s2i/assemble
COPY quarkus-binary-s2i/src/main/resources/scripts/run /usr/libexec/s2i/run
COPY quarkus-binary-s2i/src/main/resources/scripts/usage /usr/libexec/s2i/usage
