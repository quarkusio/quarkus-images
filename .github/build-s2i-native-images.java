...
@Command(name = "build-s2i-native-images", mixinStandardHelpOptions = true,
        description = "build container images providing a S2I building the application from source as a native executable")
class BuildS2iNativeImage implements Callable<Integer> {
    ...
    static final File IMAGE = new File("quarkus-native-s2i.yaml");
    static final String BUILD_SCRIPT = ".github/build-s2i-native-images.sh";
    static final String IMAGE_NAME = "quay.io/quarkus/ubi-quarkus-native-s2i";

    public static void main(String... args) {
        int exitCode = new CommandLine(new BuildS2iNativeImage()).execute(args);
