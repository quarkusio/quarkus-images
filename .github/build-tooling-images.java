...
@Command(name = "build-tooling-images", mixinStandardHelpOptions = true,
        description = "build container images providing GraalVM and tooling (Maven, Gradle...)")
class BuildToolingImage implements Callable<Integer> {
    ...
    static final File IMAGE = new File("quarkus-tooling.yaml");
    static final String BUILD_SCRIPT = ".github/build-tooling-images.sh";
    static final String IMAGE_NAME = "quay.io/quarkus/centos-quarkus-maven";

    public static void main(String... args) {
        int exitCode = new CommandLine(new BuildToolingImage()).execute(args);
