...
@Command(name = "build-mandrel-images", mixinStandardHelpOptions = true,
        description = "build container images providing the `native-image` executable from Mandrel")
class BuildMandrelImage implements Callable<Integer> {

    static final List<String> VERSIONS = Arrays.asList("20.1.0.0.Alpha1-java11", "20.1.0.1.Alpha2-java11", "20.1.0.1.Final-java11");
    static final Map<String, String> TAGS = ImmutableMap.of(
            "20.1-java11", "20.1.0.1.Final-java11"
    );

    static final File IMAGE = new File("quarkus-mandrel.yaml");
    static final String BUILD_SCRIPT = ".github/build-mandrel-images.sh";
    static final String IMAGE_NAME = "quay.io/quarkus/ubi-quarkus-mandrel";

    public static void main(String... args) {
        int exitCode = new CommandLine(new BuildMandrelImage()).execute(args);
