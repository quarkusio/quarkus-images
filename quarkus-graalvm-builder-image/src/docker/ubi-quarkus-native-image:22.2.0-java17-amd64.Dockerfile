...
# ----------------
# Module graalvm 22.2.0-java17-amd64
...
# Artifact graalvm-java17-linux-amd64-22.2.0.tar.gz downloaded from https://github.com/graalvm/graalvm-ce-builds/releases/download/vm-22.2.0/graalvm-ce-java17-linux-amd64-22.2.0.tar.gz
COPY /target/artifacts/graalvm-java17-linux-amd64-22.2.0.tar.gz /tmp/graalvm-java17-linux-amd64-22.2.0.tar.gz
RUN tar xzf /tmp/graalvm-java17-linux-amd64-22.2.0.tar.gz -C /opt \
  && mv /opt/graalvm-ce-*-22.2.0* /opt/graalvm \
  && /opt/graalvm/bin/gu --auto-yes install native-image \
  && rm -Rf /tmp/graalvm-java17-linux-amd64-22.2.0.tar.gz
# ----------------
