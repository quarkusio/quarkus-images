...
# ----------------
# Module graalvm 22.0.0.2-java11-amd64
...
# Artifact graalvm-java11-linux-amd64-22.0.0.2.tar.gz downloaded from https://github.com/graalvm/graalvm-ce-builds/releases/download/vm-22.0.0.2/graalvm-ce-java11-linux-amd64-22.0.0.2.tar.gz
COPY /artifacts/graalvm-java11-linux-amd64-22.0.0.2.tar.gz /tmp/graalvm-java11-linux-amd64-22.0.0.2.tar.gz
RUN tar xzf /tmp/graalvm-java11-linux-amd64-22.0.0.2.tar.gz -C /opt \
  && mv /opt/graalvm-ce-*-22.0.0.2* /opt/graalvm \
  && /opt/graalvm/bin/gu --auto-yes install native-image \
  && rm -Rf /tmp/graalvm-java11-linux-amd64-22.0.0.2.tar.gz
# ----------------
